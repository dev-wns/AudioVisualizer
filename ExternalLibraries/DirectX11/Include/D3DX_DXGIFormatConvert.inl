...
// Compute Material or Pixel Material on D3D11 Hardware.
//
...
// allows random access reads and writes to memory from a Compute Material
// or Pixel Material.  However, the only texture format that supports this
...
// using a UAV, or reading only using a Material Resource View (SRV).
...
//
// Suppose you want to make a texture than you can use a Pixel Material
// or Compute Material to perform in-place editing, and that the format
...
//     an exception here.
// 
// (3) In the Compute Material or Pixel Material, use the appropriate
